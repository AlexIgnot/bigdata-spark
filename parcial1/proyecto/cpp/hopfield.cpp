...
int main(void)
{
  ...
  readfile("vocalA.txt", x0,  col, N);
  readfile("vocalEO.txt", x1,  col, N);
  readfile("vocalEU.txt", x2,  col, N);
  readfile("vocalI.txt", x3,  col, N);
  readfile("vocalO.txt", x4,  col, N);
  readfile("vocalU.txt", x5,  col, N);
